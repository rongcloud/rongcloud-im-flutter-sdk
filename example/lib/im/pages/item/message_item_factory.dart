...
class MessageItemFactory extends StatelessWidget {
  ...
  Widget textMessageItem(BuildContext context) {
    ...
    TextMessage? msg = message!.content as TextMessage?;
    return Container(
  ...
  Widget sightMessageItem() {
    SightMessage? msg = message!.content as SightMessage?;
  ...
  Widget fileMessageItem(BuildContext context) {
    FileMessage fileMessage = message!.content as FileMessage;
    double screenWidth = MediaQuery.of(context).size.width;
    return Container(
  ...
  Widget richContentMessageItem(BuildContext context) {
    RichContentMessage msg = message!.content as RichContentMessage;
    double screenWidth = MediaQuery.of(context).size.width;
    return Container(
      width: screenWidth - 140,
  ...
  Widget combineMessageItem(BuildContext context) {
    CombineMessage msg = message!.content as CombineMessage;
  ...
  Widget referenceMessageItem(BuildContext context) {
    ReferenceMessage msg = message!.content as ReferenceMessage;
    double screenWidth = MediaQuery.of(context).size.width;
    return Container(
        width: screenWidth - 140,
        child: Column(children: <Widget>[
  ...
  Widget? referenceWidget(ReferenceMessage msg) {
    if (msg.referMsg is TextMessage) {
      TextMessage textMessage = msg.referMsg as TextMessage;
      ...
      ImageMessage imageMessage = msg.referMsg as ImageMessage;
      Widget widget;
