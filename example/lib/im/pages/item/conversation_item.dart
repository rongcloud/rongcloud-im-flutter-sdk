...
class ConversationItem extends StatefulWidget {
  ...
  ConversationItem(ConversationItemDelegate delegate, prefix.Message msg, bool showTime, bool multiSelect, List selectedMessageIds) {
    this.message = msg;
  ...
  State<StatefulWidget> createState() {
    return new _ConversationItemState(
        this.delegate, this.message, this.showTime, this.multiSelect, this.selectedMessageIds);
  }
}
