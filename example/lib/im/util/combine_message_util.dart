...
class CombineMessageUtils {
  ...
  Future<String> getHtmlFromMessageContent(Message message, MessageContent content) async {
    ...
    switch (type) {
      case TAG_TXT: // 文本
        TextMessage text = content as TextMessage;
      ...
      case TAG_RP: // 红包
        ...
        break;
      case TAG_SIGHT: // 小视频
        SightMessage sight = content as SightMessage;
        ...
        break;
      case TAG_IMG: // 图片
        ImageMessage image = content as ImageMessage;
        ...
        break;
      case TAG_GIF: // gif图片
        GifMessage gif = content as GifMessage;
        ...
        break;
      case TAG_FILE: // 文件
        FileMessage file = content as FileMessage;
      ...
      // break;
      case TAG_COMBINE: // 合并
        CombineMessage combine = content as CombineMessage;
  ...
  Future<String> setUserInfo(String str, Message msg) async {
    ...
    return str.replaceAll(MSG_PORTRAIT, portrait).replaceAll(MSG_SHOW_USER, showUser).replaceAll(MSG_USER_NAMEM, (await UserInfoDataSource.getUserInfo(msg.senderUserId)).name!).replaceAll(
          MSG_SEND_TIME,
          getSendTime(msg),
        );
  }
